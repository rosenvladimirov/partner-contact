...
class ResPartner(models.Model):
    ...
    def create(self, vals):
        ...
        if not vals.get("name") and vals.get("contact_id"):
            modified_contact_id = modified_self.browse(vals["contact_id"])
            vals.update({
                "name": modified_contact_id.name,
                'image_1920': modified_contact_id.image_1920,
            })
